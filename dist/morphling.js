...
var _filters = __webpack_require__(58);
  ...
  elemAttrs.forEach(function (elemAttr) {
    try {
      elemAttr.forEach(function (attr) {
        ...
        filter = filter.replace(/-\w/g, function (m) {
...
var _capitalize = __webpack_require__(59);
...
var _currency = __webpack_require__(171);
...
var _dateFormat = __webpack_require__(60);
...
var _lowercase = __webpack_require__(163);
...
var _placeholder = __webpack_require__(170);
...
var _uppercase = __webpack_require__(164);
...
var _replace = __webpack_require__(165);
...
var _reverse = __webpack_require__(166);
...
var _truncate = __webpack_require__(167);
...
exports._dateFormat = exports.dateFormat = undefined;

var _dateFns = __webpack_require__(61);

function doIt(date, _format) {
  return (0, _dateFns.format)(date, _format);
}

var dateFormat = exports.dateFormat = function dateFormat(date, _format) {
  return doIt(date, _format);
};

var _dateFormat = exports._dateFormat = function _dateFormat(el, _format) {
  var data = el.textContent;
...
function doIt(data, opts) {
  var replacee = opts.split(':')[0];
  var replacer = opts.split(':')[1];
  var re = new RegExp(replacee, 'ig');
  return data.replace(re, replacer);
}

var replace = exports.replace = function replace(data, opts) {
  return doIt(data, opts);
};

var _replace = exports._replace = function _replace(el, value) {
  var data = el.textContent;
  el.innerHTML = doIt(data, value);
};
...
var _invalidTags = __webpack_require__(169);
...
var placeholder = exports.placeholder = function placeholder(data, opts) {
  return doIt(data, opts);
};

var _placeholder = exports._placeholder = function _placeholder(el, value) {
  var data = el.textContent;
  el.innerHTML = doIt(data, value);
};
...
exports._currency = exports.currency = undefined;

var _currencies = __webpack_require__(172);
...
var currency = exports.currency = function currency(data, opts) {
  return doIt(data, opts);
};

var _currency = exports._currency = function _currency(el, value) {
  var data = el.textContent;
  el.innerHTML = doIt(data, value);
};
